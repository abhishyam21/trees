...
public class MainClass {
    public static void main(String[] args) {
        ...
        System.out.println("Height of tree wihout Recusion= "+heightOfTree.height(Root));
        heightOfTree.PrintLevelOrder(Root);
        System.out.println();

        Recursion recursion = new Recursion();
        int height = recursion.heightOfTree(Root);
        System.out.println("Height of Tree with recursion = "+height);
    }
